...
public class ApplicationForVisaModel {
   ...
   String toCountry;
   @Column(name="check_application_status")
   ...
   String dateOfApplication;
	...
	public ApplicationForVisaModel(int pkid, String travelAirports, String purposeForTravel, String plannedDateOfTravel,
			...
			String checkApplicationStatus, String dateOfApplication) {
		super();
		this.pkid = pkid;
		...
		this.checkApplicationStatus = checkApplicationStatus;
	...
	public String getCheckApplicationStatus() {
		return checkApplicationStatus;
	}


	public void setCheckApplicationStatus(String checkApplicationStatus) {
		this.checkApplicationStatus = checkApplicationStatus;
	}
