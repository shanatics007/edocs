...
<html lang="en">
   ...
   <body>
      ...
      <div id="ee-apply-form" class="ee-apply-form">
            ...
            <div class="row ee-form-container">
               <div class="ee-form-actual">
                  <div class="ee-form-steps">
                     ...
                     <div class="form-step"><span class="form-step-number">
                        2
                        </span> <span class="form-step-label">Additional<br>information</span> <span class="form-step-complete"><i class="icon-ok" style="display: none;"></i></span>
                     </div>
                     <div class="form-step"><span class="form-step-number">
                        3
                        </span> <span class="form-step-label">Check<br>your email</span> <span class="form-step-complete"><i class="icon-ok" style="display: none;"></i></span>
                     </div>
                  </div>
                     ...
                     <div id="ee-form-step1">
                        <div>
                           <div>
                              ...
                              <div class="input-box nesting-buttons" type="SignalEmitterInput" name="emiter1" label="Age 1 Egypt- 20-45" validations="" options="" reactions="[object Object]" watch="over-20;under-45" possiblereactions="" possibledisablingreactions="" possibleemits="age-1" style="display: none;">
                                 <div class="input-box-bottom">
                                    <div id="emiter1" class="actual-input">
                                       <div class="checkall-input"><label for="emiter1-track"><input type="hidden" id="emiter1-track" name="emiter1" class="invisible-input" value="false"></label></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="input-box nesting-buttons" type="SignalEmitterInput" name="emiter2" label="Age 2 Algeria - 18-35" validations="" options="" reactions="[object Object]" watch="over-18;under-35" possiblereactions="" possibledisablingreactions="" possibleemits="age-2" style="display: none;">
                                 <div class="input-box-bottom">
                                    <div id="emiter2" class="actual-input">
                                       <div class="checkall-input"><label for="emiter2-track"><input type="hidden" id="emiter2-track" name="emiter2" class="invisible-input" value="false"></label></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="input-box ee-date-input" type="CalendarInput" name="flight-date" label="Planned day of travel" hint="" placeholder="Day" tooltip="&lt;p&gt;If you don&amp;#39;t have a ticket please enter the approximate departure date. If your departure is in next 4 days please contact us.&lt;/p&gt;" required="required" validations="[object Object],[object Object],[object Object]" options="[object Object]" reactions="[object Object]" possiblereactions="" possibledisablingreactions="" possibleemits="can-upload-later" dayvalue="[object Object]" monthvalue="[object Object]" yearvalue="[object Object]" value="" dayplaceholder="Day" monthplaceholder="Month" yearplaceholder="Year" dateemits="[object Object]">
                                    ...
                                    <div class="input-mark">
                                       <i class="icon-question">
                                          <span class="hint-info-box">
                                             <p>If you don't have a ticket please enter the approximate departure date. If your departure is in next 4 days please contact us.</p>
                                          </span>
                                       </i>
                                    </div>
                                 </div>
                              ...
                              <div class="input-box ee-date-input" type="DateInput" name="birth" label="Date of birth" hint="" placeholder="" tooltip="" required="required" validations="[object Object],[object Object],[object Object]" options="[object Object]" reactions="[object Object]" possiblereactions="" possibledisablingreactions="" possibleemits="over-18,under-35,over-20,under-45" dayvalue="[object Object]" monthvalue="[object Object]" yearvalue="[object Object]" value="" dayplaceholder="" monthplaceholder="" yearplaceholder="" dateemits="[object Object],[object Object],[object Object],[object Object]">
                                 <div class="input-box-top">
                                    <div class="input-box-label">
                                       Date of birth
                                    </div>
                              ...
                              <div class="input-box" type="EmailInput" name="contact-email" label="E-mail address" hint="At this email you will receive your eVisa" placeholder="" tooltip="" required="required" validations="[object Object],[object Object]" options="" reactions="[object Object]" possiblereactions="" possibledisablingreactions="" possibleemits="" value="">
                                 <div class="input-box-top">
                                    <div class="input-box-label">
                                       E-mail address
                                    </div>
                                    <div class="input-box-hint">
                                       At this email you will receive your eVisa
                                    </div>
                                 </div>
                                 <div class="input-box-bottom">
                                    <div class="error-position"><span style="display: none;">0</span></div>
                              ...
                              <div class="input-box" type="EmailInput" name="contact-email-repeat" label="E-mail address (re-enter)" hint="The confirmation email must match your email address" placeholder="" tooltip="" required="required" validations="[object Object],[object Object],[object Object]" options="" reactions="[object Object]" possiblereactions="" possibledisablingreactions="" possibleemits="" value="">
                                 <div class="input-box-top">
                                    <div class="input-box-label">
                              ...
                              <div class="input-box" type="TelephoneInput" name="contact-phone" label="Contact phone number" hint="" placeholder="" tooltip="" required="required" validations="[object Object],[object Object]" options="" reactions="[object Object]" possiblereactions="" possibledisablingreactions="" possibleemits="" value="">
                                 <div class="input-box-top">
                                    <div class="input-box-label">
                              ...
                              <div class="input-box" type="SelectInput" name="nationality" label="Nationality" hint="" placeholder="" tooltip="" required="required" validations="[object Object]" options="[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object],[object Object]" reactions="[object Object]" possiblereactions="" possibledisablingreactions="age-2" possibleemits="[object Object]" inputvalue="[object Object]" value="[object Object]">
                                 <div class="input-box-top">
                                    <div class="input-box-label">
                                       Nationality
                                    </div>
                                 ...
                                 <div class="input-box-bottom">
                                    ...
                                    <div id="nationality" class="pseudoselect-container actual-input">
                                       <div class="date-input-full">
                                          <div tabindex="-1" class="multiselect ee-complete">
                                             <div class="multiselect__select"></div>
                                             <div class="multiselect__tags">
                                                <div class="multiselect__tags-wrap" style="display: none;"></div>
                                                <!----> 
                                                <div class="multiselect__spinner" style="display: none;"></div>
                                                <input name="" type="text" autocomplete="nope" placeholder="" tabindex="0" class="multiselect__input" style="width: 0px; position: absolute; padding: 0px;"> <span class="multiselect__single">Cuba</span> <!---->
                                             </div>
                                             <div tabindex="-1" class="multiselect__content-wrapper" style="max-height: 300px; display: none;">
                                                <ul class="multiselect__content" style="display: inline-block;">
                                                   <!----> 
                                                   <li class="multiselect__element">
                                                      <span data-select="" data-selected="" data-deselect="" class="multiselect__option"><span data-option-value="13425" class="option__title">Afghanistan</span></span> <!---->
                                                   </li>
                                                   <li class="multiselect__element">
                                                      <span data-select="" data-selected="" data-deselect="" class="multiselect__option"><span data-option-value="13338" class="option__title">Albania</span></span> <!---->
                                                   </li>
                                                   <li class="multiselect__element">
                                                   ...
                                                   <li class="multiselect__element">
                                                      <span data-select="" data-selected="" data-deselect="" class="multiselect__option"><span data-option-value="13281" class="option__title">British Dependent Ter. Cit</span></span> <!---->
                                                   </li>
                                                   <li class="multiselect__element">
                                                      <span data-select="" data-selected="" data-deselect="" class="multiselect__option"><span data-option-value="13286" class="option__title">British National Overseas</span></span> <!---->
                                                   </li>
                                                   <li class="multiselect__element">
                                                      <span data-select="" data-selected="" data-deselect="" class="multiselect__option"><span data-option-value="13280" class="option__title">British Overseas Citizen</span></span> <!---->
                                                   </li>
                                                   <li class="multiselect__element">
                                                   ...
                                                   <li class="multiselect__element">
                                                      <span data-select="" data-selected="" data-deselect="" class="multiselect__option"><span data-option-value="13454" class="option__title">Canada</span></span> <!---->
                                                   </li>
                                                   <li class="multiselect__element">
                                                   ...
                                                   <li class="multiselect__element">
                                                      <span data-select="" data-selected="" data-deselect="" class="multiselect__option"><span data-option-value="13403" class="option__title">China</span></span> <!---->
                                                   </li>
                                                   <li class="multiselect__element">
                                                   ...
                                                   <li class="multiselect__element">
                                                      <span data-select="" data-selected="" data-deselect="" class="multiselect__option multiselect__option--highlight multiselect__option--selected"><span data-option-value="13484" class="option__title">Cuba</span></span> <!---->
                                                   </li>
                                                   <li class="multiselect__element">
                                                   ...
                                                   <li class="multiselect__element">
                                                      <span data-select="" data-selected="" data-deselect="" class="multiselect__option"><span data-option-value="13423" class="option__title">Malaysia</span></span> <!---->
                                                   </li>
                                                   <li class="multiselect__element">
                                                   ...
                                                   <li class="multiselect__element">
                                                      <span data-select="" data-selected="" data-deselect="" class="multiselect__option"><span data-option-value="13279" class="option__title">United Kingdom</span></span> <!---->
                                                   </li>
                                                   <li class="multiselect__element">
                                    ...
                                    <div class="success-mark"><i class="icon-ok"><span class="hint-info-box"></span></i></div>
                                    <!----> <!---->
                                 </div>
                              </div>
                              <div class="input-box" type="SelectInput" name="type-of-visa" label="Purpose for travel" hint="" placeholder="" tooltip="" required="required" validations="[object Object]" options="[object Object],[object Object]" reactions="[object Object]" watch="PurposesForTravel" possiblereactions="" possibledisablingreactions="" possibleemits="visa-single" inputvalue="[object Object]" value="[object Object]">
                                 <div class="input-box-top">
                                    <div class="input-box-label">
                                       Purpose for travel
                                    </div>
                                       ...
                                       <div class="date-input-full">
                                          <div tabindex="-1" class="multiselect ee-complete">
                                             ...
                                             <div class="multiselect__tags">
                                                ...
                                                <!----> 
                                                <div class="multiselect__spinner" style="display: none;"></div>
                                                <input name="" type="text" autocomplete="nope" placeholder="" tabindex="0" class="multiselect__input" style="width: 0px; position: absolute; padding: 0px;"> <span class="multiselect__single">Single entry</span> <!---->
                                             </div>
                                             <div tabindex="-1" class="multiselect__content-wrapper" style="max-height: 299.642px; display: none;">
                                                <ul class="multiselect__content" style="display: inline-block;">
                                                   <!----> 
                                                   <li class="multiselect__element">
                                                      <span data-select="" data-selected="" data-deselect="" class="multiselect__option"><span data-option-value="transit" class="option__title">Transit</span></span> <!---->
                                                   </li>
                                                   <li class="multiselect__element">
                                                      <span data-select="" data-selected="" data-deselect="" class="multiselect__option multiselect__option--highlight multiselect__option--selected"><span data-option-value="single" class="option__title">Single entry</span></span> <!---->
                                                   </li>
                                                   <li style="display: none;"><span class="multiselect__option"><span>Oops! No elements found. Consider changing the search query.</span></span></li>
                                                   <li style="display: none;"><span class="multiselect__option">List is empty.</span></li>
                                                </ul>
                              ...
                              <div class="input-box" type="LabelInput" name="documents-remember-label" label="&lt;p style=&quot;font-size:16px;&quot;&gt;&lt;span style=&quot;color:#e67e22;&quot;&gt;Please show at the border: Proof of holding of the amount of at least 50 USD or the equivalent in foreign currency for each day of stay in Turkey.&lt;/span&gt;&lt;/p&gt;
                                 ...
                                 <div class="label-input">
                                    <p style="font-size:16px;"><span style="color:#e67e22;">Please show at the border: Proof of holding of the amount of at least 50 USD or the equivalent in foreign currency for each day of stay in Turkey.</span></p>
                                 </div>
                                 <!---->
                              </div>
                              <div class="form-module-outbox form-module-insurance_module" label="Insurance" code_name="insurance_module" showon="showModuleInsuranceFields" fields="[object Object]" questionfield="[object Object]" product="[object Object]">
                                 <div class="input-box module-main-question " type="YesNoInput" name="module-insurance-want-insurance" label="Would you like to add insurance?" hint="" placeholder="" tooltip="" validations="[object Object]" options="[object Object],[object Object]" reactions="[object Object]" ismainquestion="true" possiblereactions="" possibledisablingreactions="" possibleemits="showModuleInsuranceFields" value="997">
                                    <div class="input-box-top">
                                       <div class="input-box-label">
                                    ...
                                    <div class="input-box-bottom">
                                       ...
                                       <div id="module-insurance-want-insurance" class="actual-input">
                                          <div class="radio-input-double">
                                             <div class="radio-option-container ee-complete"><input type="radio" name="module-insurance-want-insurance" id="module-insurance-want-insurance997" value="997"> <label for="module-insurance-want-insurance997">No</label></div>
                                          ...
                                          <div class="price-label-input price-in-block">
                                             <div>
                                                <div style="font-weight:bold;font-size:16px;">
                                                   <div class="signal-iduna-image"><img src="./applicationform_files/signal-iduna-vector-logo.svg" style="height: 24px;"></div>
                        ...
                        <div>
                           <div>
                              <h1></h1>
                              <div class="input-box" type="CheckAllInput" name="accept-all-terms" label="Check all (checks all the checkboxes below)" hint="" placeholder="" tooltip="" validations="" options="" reactions="[object Object]" possiblereactions="" possibledisablingreactions="" possibleemits="check-all">
                                 <div class="input-box-bottom">
                                    <div class="error-position"></div>
                                    <div id="accept-all-terms" class="actual-input">
                                       <div class="checkall-input"><label for="accept-all-terms-track" class="checkbox-all-label checkbox-label">
                                          Check all (checks all the checkboxes below)
                                          <input type="checkbox" id="accept-all-terms-track" name="accept-all-terms"> <span class="checkmark"></span></label>
                                       </div>
                                    </div>
                                    <div class="input-mark"></div>
                                 </div>
                              </div>
                              <div class="input-box nested-checkbox" type="CheckboxInput" name="accept-terms" label="I accept the &lt;a href=&quot;/en/rules/terms-of-service&quot; target=&quot;_blank&quot;&gt;Terms&lt;/a&gt; and &lt;a href=&quot;/pdf/evisa-express-terms-of-service.pdf#page=6&quot; target=&quot;_blank&quot;&gt;Conditions&lt;/a&gt;." hint="" placeholder="" tooltip="" required="required" validations="" options="" reactions="[object Object]" watch="check-all" possiblereactions="" possibledisablingreactions="" possibleemits="" value="true">
                                 <div class="input-box-bottom">
                                    <div class="error-position"><span style="display: none;">0</span></div>
                              ...
                              <div class="input-box" type="SubmitInput" name="go-to-step-2" label="SEND AND PAY" hint="" required="required" validations="" options="" reactions="[object Object]" possiblereactions="" possibledisablingreactions="" possibleemits="">
                                 <div class="input-box-bottom button-container submit-input-container">
                                    <button class="btn">SEND AND PAY</button> <!---->
                                 </div>
                              </div>
                           </div>
                        </div>
               ...
               <div class="ee-form-sidebar ee-form-sidebar--top">
                  <div class="ee-form-info">
                     ...
                     <div class="form-infobox">
                        ...
                        <div class="form-info-element"><span>
                           Visa
                           </span> <span>
                           69.00 EUR
                           </span>
                     ...
                     <div class="form-pricebox">
                        <div class="form-info-element">
                           <div class="form-choose-currency-wrapper">
                              <span>
                              Full price
                              </span> 
                              <div class="form-choose-currency">
                                 <span>
                                 69.00
                                 </span> <!----> <span class="form-choose-currency-text">
                                 EUR
                                 </span>
                              </div>
                           </div>
                           <div class="form-pricebox-info">
                              Price may vary depending on currency
                           </div>
                           <div class="form-pricebox-info">
                              <div>Available payment methods:</div>
                              <div class="form-pricebox-payment-methods"><span><img src="./applicationform_files/mastercard.png"></span><span><img src="./applicationform_files/visa.png"></span><span><img src="./applicationform_files/american_express.png"></span><span><img src="./applicationform_files/diners_club.png"></span><span><img src="./applicationform_files/jcb.png"></span><span><img src="./applicationform_files/discover.png"></span><span><img src="./applicationform_files/sofort.png"></span><span><img src="./applicationform_files/paypal.png"></span></div>
                           </div>
                        </div>
                        <!---->
                     </div>
         ...
         <div class="ee-form-loader" style="display: none;"><img src="./applicationform_files/loader.svg" alt="Evisa Express"></div>
         <div onclick="window.hideInsuranceInfo()" class="insurance-info-wrapper" style="display: none;">
            <div onclick="falseHideInsiranceInfoClick(event)" class="insurance-info-container">
               <img src="./applicationform_files/signal-iduna-vector-logo.svg" class="signal-iduna-logo"> <button onclick="window.hideInsuranceInfo()" class="insurance-info-close"><img src="./applicationform_files/close.svg"></button> 
               <h1>SAFE TRAVEL</h1>
            ...
            <div class="container">
               ...
               <div class="cookies-confirm">
                  <div class="button-container">
                     <button class="btn cookies-accept" title="&lt;p&gt;I agree&lt;/p&gt;
                        ">
                        <p>I agree</p>
                     </button>
                  </div>
      ...
      <script>
         ...
         window.onerror = function (message, file, lineNo) {
             ...
             var params = window.location.href + ' ' + file + ':' + lineNo + ' ' + message;
             httpLog.open("POST", "/logger", true);
             httpLog.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
             httpLog.send(JSON.stringify({ message: params }));
         ...
         document.addEventListener('DOMContentLoaded', function () {
             ...
             for (var i = 0; i < insertPhone.length; i++) {
                 insertPhone[i].setAttribute('href', 'tel:+44 2031 293 603'.replace(/ /g, ""));
                 insertPhone[i].innerHTML = '<span class="phone-lang-name">es</span> +44 2031 293 603';
             }
      ...
      <div class="settingsModalOverlay hidden" id="languageSettings">
         <div class="settingsModal">
            <div class="settingsModal__title desktopOnly">
               Region Settings
               <button class="closeButton" data-on-click="closeLocaleSettings"><img src="./applicationform_files/close(1).svg" width="14" height="14"></button>
            </div>
            <div class="settingsModal__title mobileOnly"><button class="closeLocaleSettingsMobile" data-on-click="closeLocaleSettings"><img src="./applicationform_files/arrow-left.svg" width="14" height="10"><span>Back</span></button></div>
            <form class="settingsModal__content">
               <div class="formGroup">
                  <div class="formGroup__title"><img src="./applicationform_files/world.svg" width="20" height="20"> Language
                  </div>
                  <input type="hidden" id="locale-actual-language" value="en">
                  <select class="optionsSelect" id="locale-language">
               ...
               <div class="formGroup">
                  <div class="formGroup__title"><img src="./applicationform_files/currency.svg" width="20" height="20"> Currency
                  </div>
                  <select class="optionsSelect" id="locale-currency" value="">
                     <option value="USD" disabled="">USD (Unavailable With Insurance)</option>
                     <option value="EUR">EUR</option>
                  </select>
               </div>
               <button class="btn btn-burgund btn-filled" data-on-click="applyLocaleSettings">SAVE</button><button class="btn btn-burgund btn-outline" data-on-click="closeLocaleSettings" type="button">CANCEL</button>
            </form>
         </div>
      </div>
      <script>
